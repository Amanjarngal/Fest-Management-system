...
const Stalls = () => {
  ...
  if (loading)
    return (
      <div className="flex justify-center items-center min-h-screen bg-[#05010a] text-purple-400 text-lg animate-pulse">
        Loading Stalls...
      </div>
    );

  return (
    <div className="min-h-screen bg-[#05010a] text-white p-8 md:p-10">
      {/* Header + Add Form */}
      <div className="mb-10">
        ...
        <div className="bg-gray-900/70 border border-gray-800 rounded-2xl p-6 shadow-xl max-w-4xl mx-auto backdrop-blur-md">
          <h2 className="text-2xl font-semibold bg-gradient-to-r from-pink-400 to-purple-400 bg-clip-text text-transparent mb-4 flex items-center gap-2">
          ...
          >
            ...
            <div className="md:col-span-2">
              ...
              <textarea
                ...
                className="w-full p-3 rounded-lg bg-gray-800 border border-gray-700 focus:outline-none focus:ring-2 focus:ring-purple-500 min-h-[80px]"
              />
            </div>
            ...
            <div className="md:col-span-2 text-center">
              <button
                type="submit"
                className="bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-500 hover:to-pink-400 text-white font-semibold py-3 px-6 rounded-lg shadow-md transition-all"
              >
      ...
      {/* ✅ Display Stalls */}
      {stalls.length === 0 ? (
        <p className="text-gray-400 text-center mt-16 text-lg">No stalls created yet.</p>
      ) : (
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {stalls.map((stall) => (
            <div
              key={stall._id}
              className="bg-gray-900/70 border border-gray-800 rounded-2xl p-6 shadow-xl hover:shadow-purple-600/30 transition-all backdrop-blur-md"
            >
              {stall.imageUrl && (
                <img
                  src={stall.imageUrl}
      ...
      {editingStall && (
        <div className="fixed inset-0 bg-black/70 flex justify-center items-center z-50">
          <div className="bg-gray-900/80 border border-gray-800 rounded-2xl p-6 w-full max-w-lg shadow-xl relative backdrop-blur-md">
            <button
            ...
            <form onSubmit={handleUpdateStall} className="space-y-4">
                ...
                (field) => (
                  <div key={field}>
                    ...
                    <input
                      ...
                      className="w-full p-3 rounded-lg bg-gray-800 border border-gray-700 focus:ring-2 focus:ring-purple-500"
                    />
                  </div>
                )
              )}
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-purple-600 to-pink-500 hover:from-purple-500 hover:to-pink-400 text-white font-semibold py-3 rounded-lg transition-all"
              >
                Update Stall
              </button>
            </form>
